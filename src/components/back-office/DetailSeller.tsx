      ...
      <section className="h-full flex flex-col justify-between p-8 rounded-xl space-y-6 bg-slate-800">
        <div className="flex flex-col lg:flex-row items-center gap-6">
          <div className=" flex items-center justify-center lg:w-1/4 relative ">
            {seller?.image ? (
              ...
              <div className="w-48 h-48 flex items-center justify-center border border-white text-center p-2">
          ...
          <div className="flex flex-col lg:w-3/4 gap-6 flex-wrap">
            <div className="space-y-4">
              ...
              <div className="p-4 lg:pr-24 bg-slate-900 space-y-4 rounded-xl">
        ...
        <div className="flex items-center">
          <form className="space-x-6" onSubmit={updateStatus}>
            <select
              className="bg-slate-900 border-none outline-none"
              value={status}
