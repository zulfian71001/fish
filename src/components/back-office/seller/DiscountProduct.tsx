              ...
              <tr className="bg-slate-900 border-b dark:bg-gray-800 text-slate-100  dark:border-gray-700">
                ...
                <td className="px-6 py-4">
                  <p className="line-clamp-1">
                    Laptop fmadklsfnasp kfnaklfnl fkdslfka;p nvdskfngdkl
                    gksdngksdn gndksngsdkl
                  </p>
                </td>
                ...
                <td className=" px-6 py-4 items-center ">
                  <div className="flex  items-center gap-4">
                    ...
                    <button className=" w-10 h-10 flex justify-center items-center rounded-xl bg-yellow-400 hover:bg-yellow-600">
                      <SquarePen />
                    </button>
